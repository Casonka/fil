...
Перед тем, как скачивать и подключать библиотеки, убедитесь что в структуре вашего проекта присутствует папка External. Тем не менее, ниже будет приведена инструкция по установке внешний библиотек, в том числе самого External Manager.

- Посетите репозиторий с [External Manager]().
